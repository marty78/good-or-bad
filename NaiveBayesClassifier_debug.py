...
def main():
	...
	correctly_classified_train, num_documents_train, _ = classify(training_file, num_good_training, num_bad_training, word_freq)
	correctly_classified_test, num_documents_test, time_testing = classify(testing_file, num_good_training, num_bad_training, word_freq)
